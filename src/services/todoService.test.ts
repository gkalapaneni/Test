...
describe('TodoService', () => {
  ...
  beforeEach(() => {
    mockTodoRepository = mock<ITodoRepository>();
    todoRepositoryInstance = instance(mockTodoRepository);
    todoService = new TodoService(todoRepositoryInstance);
  });
